...
- `environment` (String) The cloud environment to use. Supported values are `public`, `china`, and `usgovernment`. This can also be sourced from the `ARM_ENVIRONMENT` Environment Variable. Defaults to `public`.
