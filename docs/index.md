...
- `msgraph_endpoint` (String) The Microsoft Graph endpoint to use, including the scheme. This can also be sourced from the `ARM_MSGRAPH_ENDPOINT` environment variable. Defaults to `https://graph.microsoft.com`.
